      ...
      <div className="helloWrap">
        <svg className="helloBot" viewBox="0 0 180 150" aria-hidden="true">
          <g stroke="#1ECBE1" strokeWidth="3" fill="#0A1829" strokeLinejoin="round">
            ...
            <circle cx="81.5" cy="51" r="5" fill="#1ECBE1" stroke="none" />
            <circle cx="99.5" cy="51" r="5" fill="#1ECBE1" stroke="none" />
            ...
            <g className="waveArm">
              ...
              <path d="M113 54 Q110 43 113 39" fill="none" strokeWidth="2" strokeLinecap="round" />
              <line x1="118" y1="45" x2="118" y2="39" strokeWidth="2" strokeLinecap="round" />
              <path d="M123 56 Q126 43 123 39" fill="none" strokeWidth="2" strokeLinecap="round" />
            </g>
          </g>
        </svg>
